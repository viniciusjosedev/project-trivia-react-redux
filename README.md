...
### Heitor Pereira ficou responsável pela parte inicial da tela de Login, botão que leva as configurações da tela de Login, Header da página, estilização da página de Feedbacks, funcionalidade do esquema de cores de respostas certas e erradas, criação da opção para a pessoa jogadora poder jogar novamente e criação do conteúdo da tela de Ranking.
